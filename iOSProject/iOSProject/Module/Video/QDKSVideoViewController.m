...
#import "QDKSVideoViewController.h"
...
@interface QDKSVideoViewController ()  <UITableViewDelegate,UITableViewDataSource>
...
@implementation QDKSVideoViewController
...
- (void)viewDidLoad {
    ...
    [button setTitle:@"打开小窗" forState:UIControlStateNormal];
...
- (void)buttonClicked{
    self.player.containerView.frame = CGRectMake(0, 0, 200, 200);
}
